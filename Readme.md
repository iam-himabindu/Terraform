...
- Create User with permission and configure AWS Access Key and Secret Access Key
 ...
 Follow [this article](https://palak-bhawsar.hashnode.dev/terraform-create-vpc-subnets-and-ec2-instances-in-multiple-availability-zones) to configure AWS CLI
